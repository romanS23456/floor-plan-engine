...
ISSUE_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "PROGRAM_REQUIRED_ROOM_TYPE_MISSING": {
        "category": "program",
        "default_severity": "error",
        "default_message": "Required room type is missing from plan",
        "default_consequence": "Program requirement not met",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    ...
    "PROGRAM_TOO_MANY_ROOMS_OF_TYPE": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Too many rooms of specified type",
        "default_consequence": "May exceed program requirements",
        "default_confidence": "high",
        "default_fixability": "manual_review_required",
    },
    "PROGRAM_ROOM_AREA_BELOW_MINIMUM": {
        ...
        "default_consequence": "Room may not meet program requirements",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_ROOM_AREA_ABOVE_MAXIMUM": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Room area is above program maximum",
        "default_consequence": "Room exceeds program requirements",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_TARGET_AREA_MISMATCH": {
        "category": "program",
        "default_severity": "info",
        "default_message": "Room area differs significantly from target",
        "default_consequence": "Room size may not match intent",
        "default_confidence": "medium",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_REQUIRED_ADJACENCY_MISSING": {
        ...
        "default_consequence": "Spatial relationship not as specified in program",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_FORBIDDEN_ADJACENCY_EXISTS": {
        ...
        "default_consequence": "Spatial relationship violates program",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_UNSUPPORTED_ADJACENCY_TYPE": {
        "category": "program",
        "default_severity": "info",
        "default_message": "Adjacency type is not supported in this version",
        "default_consequence": "Check not performed",
        "default_confidence": "high",
        "default_fixability": "not_fixable",
    },
    "PROGRAM_EMPTY": {
        "category": "program",
        "default_severity": "info",
        "default_message": "Room program has no requirements",
        "default_consequence": "No program validation performed",
        "default_confidence": "high",
        "default_fixability": "manual_review_required",
    },
    "PROGRAM_INVALID_REQUIREMENT": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Room program requirement is invalid or incomplete",
