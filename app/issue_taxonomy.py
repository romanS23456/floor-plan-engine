...
ISSUE_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    # MVP 7 - RoomProgram issues
    "PROGRAM_REQUIRED_ROOM_TYPE_MISSING": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Required room type is missing from the plan",
        "default_consequence": "Plan does not meet program requirements",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_TOO_FEW_ROOMS_OF_TYPE": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Too few rooms of required type",
        "default_consequence": "Plan does not meet program quantity requirements",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_TOO_MANY_ROOMS_OF_TYPE": {
        "category": "program",
        "default_severity": "info",
        "default_message": "More rooms than specified in program",
        "default_consequence": "Plan exceeds program quantity limits",
        "default_confidence": "high",
        "default_fixability": "manual_review_required",
    },
    "PROGRAM_ROOM_AREA_BELOW_MINIMUM": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Room area is below minimum required by program",
        "default_consequence": "Room does not meet program size requirements",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_ROOM_AREA_ABOVE_MAXIMUM": {
        "category": "program",
        "default_severity": "info",
        "default_message": "Room area exceeds maximum allowed by program",
        "default_consequence": "Room exceeds program size limits",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_TARGET_AREA_MISMATCH": {
        "category": "program",
        "default_severity": "info",
        "default_message": "Room area differs significantly from target area",
        "default_consequence": "Room size may not match program intent",
        "default_confidence": "medium",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_REQUIRED_ADJACENCY_MISSING": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Required adjacency between room types is missing",
        "default_consequence": "Plan does not meet program adjacency requirements",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_FORBIDDEN_ADJACENCY_EXISTS": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Forbidden adjacency exists between room types",
        "default_consequence": "Plan violates program separation requirements",
        "default_confidence": "high",
        "default_fixability": "operation_candidate_possible",
    },
    "PROGRAM_UNSUPPORTED_ADJACENCY_TYPE": {
        "category": "program",
        "default_severity": "info",
        "default_message": "Adjacency type is not yet supported for validation",
        "default_consequence": "Adjacency requirement cannot be validated",
        "default_confidence": "high",
        "default_fixability": "not_fixable",
    },
    "PROGRAM_EMPTY": {
        "category": "program",
        "default_severity": "info",
        "default_message": "Room program is empty (no requirements defined)",
        "default_consequence": "No program validation can be performed",
        "default_confidence": "high",
        "default_fixability": "manual_review_required",
    },
    "PROGRAM_INVALID_REQUIREMENT": {
        "category": "program",
        "default_severity": "warning",
        "default_message": "Room program requirement is invalid",
        "default_consequence": "Requirement cannot be validated",
        "default_confidence": "high",
        "default_fixability": "manual_review_required",
    },
}
